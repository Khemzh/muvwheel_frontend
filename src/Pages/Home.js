        ...
        <ol>
          <div className="listOfBus">
            ...
            <p className="busToBus">
              A &rarr; B<div className="whiteLine"></div>
            </p>
            <p className="number">50</p>
            <p className="busToBus">
              A &rarr; B<div className="whiteLine"></div>
  ...
  const [mainbox, setmain] = useState(
    <div>
      <button className="busClick" onClick={() => click(listBus)}>
        <img className="bus1" src="/img/icon _car outline_.png" alt=" " />
      </button>
    </div>,
  )
    ...
    <div className="App">
      ...
      <div className="bg">
        <div className="header">
          <div class="dp">
            <button className="bbb" onClick={togglePopup}>
              <img className="bt" src="/img/icon _menu_.png"></img>
            </button>
            {isPopupVisible && (
              <div className="popup-menu">
                <ul>
                  <ol>
                    <div>
                      <div className="pic">
                        <button className="back" onClick={togglePopup}>
                          <img
                            className="bbb1"
                            src="/img/leading-icon.png"
                          ></img>
                        </button>
